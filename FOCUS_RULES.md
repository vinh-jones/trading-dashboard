...
| **Assigned CC breach imminent** | Active CC whose strike sits below the share basis with sigmas-to-breach < 0.5 (within ½σ of being called). CCs at or above basis and modeled (non-active) capacity are excluded — a breach above basis is a profitable exit, not a loss to manage. | Assigned-share income |
...
| **Assigned CC breach imminent** | Active CC whose strike sits below the share basis with sigmas-to-breach in 0.5–1.0σ. Same exclusions as P1 variant (CC at/above basis or modeled excluded). | Assigned-share income |
