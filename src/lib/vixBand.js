export function getVixBand(vix) {
  ...
  if (vix <= 22) return { label: "18–22", sentiment: "Transition",    floorPct: 0.15, ceilingPct: 0.20 };
  if (vix <= 25) return { label: "22–25", sentiment: "Fear",          floorPct: 0.10, ceilingPct: 0.15 };
