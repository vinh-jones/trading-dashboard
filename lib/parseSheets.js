...
function processLeapsShares(rows) {
  ...
  for (const row of rows) {
    ...
    else if (txnType.includes("Bear") || txnType.includes("Spread") || desc.includes("Spread") || desc.includes("Bear")) {
      type = "Spread"; subtype = (txnType || desc).includes("Debit") ? "Bear Debit" : "Bear Call";
    }
